...
== Description ==
With this plugin, you can show the map with the restaurant in all the places you want.
...
All automatically. For each restaurant, also they display details such as stars, address, website. 
The list of restaurants is ordered from the nearest center of the map to farthest. 
